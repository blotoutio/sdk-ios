...
/*
 ...
 NSURLSessionConfiguration *sessionConfiguration = [NSURLSessionConfiguration backgroundSessionConfigurationWithIdentifier:kNSURLNetworkConfigurationIdentifier];
...
-(void)executorConfigurationWithBackgroundIdentifier:(NSString *)identifier{
    @try {
        ...
        self.session = [NSURLSession sessionWithConfiguration:sessionConfiguration delegate:self delegateQueue:nil];
        [self.taskPromiseObjectMap removeAllObjects];
        //concurrentQueue = dispatch_queue_create("com.BOFtrax.promiseexecuterqueue", DISPATCH_QUEUE_CONCURRENT);
    } @catch (NSException *exception) {
        BOFLogDebug(@"%@:%@", BOF_DEBUG, exception);
    }
}
...
-(void)URLSession:(NSURLSession *)session downloadTask:(NSURLSessionDownloadTask *)downloadTask didFinishDownloadingToURL:(NSURL *)location{
    @try {
        ...
        //[self.taskPromiseObjectMap removeObjectForKey:downloadTask];
    } @catch (NSException *exception) {
        BOFLogDebug(@"%@:%@", BOF_DEBUG, exception);
    }
}
