//
//  BOASDKManifestConstants.h
//  BlotoutAnalytics
//
//  Created by Blotout on 10/03/20.
...
extern NSString * const Interval_Store_Events;
extern NSString * const Event_Push_System_Events;
extern NSString * const Event_SDK_Map_User_Id;
extern NSString * const Event_SDK_Behaviour_Id;
extern NSString * const Event_Push_PII_Events;
extern NSString * const Event_Push_PHI_Events;
