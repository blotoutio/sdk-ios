...
dispatch_queue_t bo_dispatch_queue_create_specific(const char *label,
...
void bo_dispatch_specific(dispatch_queue_t queue, dispatch_block_t block,
...
void bo_dispatch_specific_async(dispatch_queue_t queue,
                                dispatch_block_t block)
{
    bo_dispatch_specific(queue, block, NO);
}

void bo_dispatch_specific_sync(dispatch_queue_t queue,
                               dispatch_block_t block)
{
